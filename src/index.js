document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    const percentage = (quiz.currentQuestionIndex * 100) / questions.length;
    console.log("percentage", percentage);
    progressBar.style.width = `${percentage}%`;
    console.log("currentQuestionIndex", quiz.currentQuestionIndex); // This value is hardcoded as a placeholder
    ...
    const choices = quiz.questions[quiz.currentQuestionIndex].choices;
